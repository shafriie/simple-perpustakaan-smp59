...
<section id="pricing" class="pricing-area section-big">
    <div class="container">
        ...
        <div class="row">
            ...
            <!-- Pricing Table -->
            <div class="col-md-12">
                <form method="POST" action="<?php echo base_url('buku/update_data'); ?>">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group"> 
                                <label >Kode Buku</label>
                                <input type="hidden" name="id" class="form-control" required value="<?php echo $id ?>">
                                <input type="text" name="kd_buku" class="form-control" required value="<?php echo $kd_buku ?>">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> 
                                <label >Nama Buku</label>
                                <input type="text" name="nama_buku" class="form-control" required value="<?php echo $nama_buku ?>">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> 
                                <label >Nama Pengarang</label>
                                <input type="text" name="nama_pengarang" class="form-control" required value="<?php echo $nama_pengarang ?>">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> 
                                <label >Nama Penerbit</label>
                                <input type="text" name="nama_penerbit" class="form-control" required value="<?php echo $nama_penerbit ?>">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> 
                                <label >Tahun Terbit</label>
                                <input type="number" name="tahun_terbit" class="form-control" required value="<?php echo $tahun_terbit ?>">
                            </div>
                        </div>
